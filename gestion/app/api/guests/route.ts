...
const ALLOWED_GUEST_FIELDS = [
  'first_name','last_name','full_name_normalized','phone_e164','group_name','family_side','guest_category','invitation_status','attendance_status','dietary_type','dietary_detail','reconfirmation_status','guest_status','notes'
];
