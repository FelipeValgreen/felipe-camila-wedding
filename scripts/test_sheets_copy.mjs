...
(async () => {
  ...
  // Fetch metadata of original spreadsheet
  ...
  const sheets = originalMeta.sheets || [];

  console.log('Original Spreadsheet Title:', originalMeta.properties?.title);
  console.log('Original Spreadsheet Sheets Count:', sheets.length);
})();
