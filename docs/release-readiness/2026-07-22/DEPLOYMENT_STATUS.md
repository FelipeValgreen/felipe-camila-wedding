...
|---|---|---|---|---|---|---|
| **Producción** | `main` | `82e9f0bcb8d` | `https://felipeycami.cl` | `2026-07-20 23:39:30 GMT` | **Activo** | Etag matches local `index.html` MD5 hash (`5596f39625fbdf5084e7524dff6e3a9b`) and `server: Vercel` headers. |
| **Release Preview** | `release/invitation-readiness-2026-07-22` | Pending push | Vercel Branch Preview | Pending push | **Pending** | Vercel Git integration creates preview builds automatically on push. |
...
### Local index.html Checksum:
```bash
$ md5 index.html
MD5 (index.html) = 5596f39625fbdf5084e7524dff6e3a9b
```
Both values are identical, confirming the `main` branch head is the active deployed production build.
